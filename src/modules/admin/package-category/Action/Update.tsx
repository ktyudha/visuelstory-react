...
import useUpdatePackageCategory from "@services/admin/package-category/hooks/useUpdatePackageCategory";
import useGetPackageCategory from "@services/admin/package-category/hooks/useGetPackageCategory";
...
export default function PackageCreate() {
  ...
  const { data, loading } = useGetPackageCategory(
